...
rules_agreement_dialog = Dialog(
    Window(
        ...
        Const('Перед началом использования YOLICO бота пользователь обязан ознакомиться с Условиями использования '
              ...
              '5. Притензии по качеству обработанных видео/фото не принимаются.\n\n'

              'Ограничение ответственности:\n\n'
              '1. YOLICO бот совершает обработку фото/видео в ознакомительных целях, и не несет ответственности за '
              'эти материалы.\n\n'
              '2. Пользователь, получивший обработанные видео/фото, несет полную ответственность за использование '
